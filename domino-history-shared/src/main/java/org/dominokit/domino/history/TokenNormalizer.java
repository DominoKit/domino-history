...
public class TokenNormalizer {
  ...
  public static DefaultNormalizedToken normalize(String rootPath, String original, String target) {
    if (validateToken(target)) return new DefaultNormalizedToken(new StateHistoryToken(rootPath, original));
   ...
   * @return {@link NormalizedToken}
   */
  public static NormalizedToken normalizeFragmentsTail(String rootPath, String original, String target) {
    if (validateToken(target)) return new DefaultNormalizedToken(new StateHistoryToken(rootPath, original));
   ...
   * @return {@link NormalizedToken}
   */
  public static DefaultNormalizedToken normalizePaths(String rootPath, String original, String target) {
    if (validateToken(target)) return new DefaultNormalizedToken(new StateHistoryToken(rootPath, original));
   ...
   * @return {@link NormalizedToken}
   */
  public static DefaultNormalizedToken normalizeFragments(String rootPath, String original, String target) {
    if (validateToken(target)) return new DefaultNormalizedToken(new StateHistoryToken(rootPath, original));
   ...
   * @return {@link NormalizedToken}
   */
  public static DefaultNormalizedToken normalizeParameters(String rootPath, String original, String target) {
    if (validateToken(target)) return new DefaultNormalizedToken(new StateHistoryToken(rootPath, original));
